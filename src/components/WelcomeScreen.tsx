          ...
          {!user && (
            ...
            >
              <div className="flex items-center gap-2 w-full max-w-xs">
                ...
                <span className="text-xs text-muted-foreground font-typewriter">أو</span>
                <div className="flex-1 h-px bg-border" />
              </div>
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 px-8 py-3 bg-white hover:bg-gray-50 text-gray-800 font-typewriter rounded-lg transition-all disabled:opacity-50 border border-gray-200"
              >
